        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="avatar avatar-online">
              <img src="{{ auth('admin')->user()->picture ?: asset('placeholder.jpeg') }}" alt class="h-auto rounded-circle">
            </div>
          </a>
              ...
              <a class="dropdown-item" href="#">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    <span class="fw-medium d-block">{{ Str::limit(auth('admin')->user()->name, 10) }}</span>
                    <small class="text-muted">{{ Str::limit(auth('admin')->user()->email, 15) }}</small>
                  </div>
                </div>
              </a>
            </li>
  ...
  <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <form class="row g-3" action="{{ route('admin.logout') }}">
          @csrf
