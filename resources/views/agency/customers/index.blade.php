...
<div class="card">
  <div class="card-header header-elements d-flex justify-content-between align-items-center">
    ...
    <form class="form d-flex align-items-center" method="GET" action="#">
      <a href="{{ route('agency.customers.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" title="{{ __('Add New') }}">
    ...
    <table class="table table-hover data-table">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          ...
          <td>
            <a class="dropdown-item" href="{{ route('agency.customers.show', $datum) }}" class="dropdown-item">
          ...
          <td>
            <a href="{{ route('agency.customers.edit', $datum) }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" title="{{ __('Edit') }}">
              <i class="fa-solid fa-pen-to-square"></i>
            </a>
            <a href="{{ route('agency.customers.show', $datum) }}" class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-info" title="{{ __('View') }}">
            ...
            <form id="delete-form-{{ $datum->id }}" action="{{ route('agency.customers.destroy', $datum) }}" method="POST" style="display: none;">
              @csrf
              @method('DELETE')
            </form>
          </td>
