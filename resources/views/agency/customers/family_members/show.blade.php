...
<li class="breadcrumb-item">
  <a href="{{ route('agency.customers.show', $familyMember->customer) }}">{{ __('View Customer') }} {{ $familyMember->customer->first_name }} {{ $familyMember->customer->last_name }}</a>
</li>
...
<div class="card">
  <div class="card-header header-elements d-flex justify-content-between align-items-center">
    ...
    <div class="form d-flex align-items-center">
      <a href="{{ route('agency.family-members.edit', $familyMember) }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-primary" title="{{ __('Edit') }}">
